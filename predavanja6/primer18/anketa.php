...
<?php 
	...
	echo "Otvoren sesija korisnika  ". $_SESSION["korisnik"];
	}
   else
...
<select   name="pitanje3" >
 ...
 <h3><b>Komentar</b></h3>
     ...
     <p><small> Komentari koji su upisani samo velikim ili samo malim slovima  biće označeni kako nevalidni </small></p>
 </div>
