  ...
  <body>
    <form action="primer1.php" method="get">
      <p>
        ...
        <input type="number" min="1" max="31" id="dan"name="dan" value ="<?php echo $_GET['dan']?>" />
      </p>
      <br />
      <p>
        <label for="mesec">Mesec</label>
        <input type="number" min="1" max="12" id="mesec" name="mesec" value ="<?php echo $_GET['mesec']?>"/>
      </p>
      <br />
      <p>
        <label for="godina">Godina</label>
        <input type="number" min="1900" max="2024" id="godina" name="godina" value ="<?php echo $_GET['godina']?>"/>
      </p>
      <br />
      <input type="submit" />
    </form>
