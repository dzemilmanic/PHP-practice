...
<body>
    <form action="forma.php" method="GET">
        ...
        <select name="godina">
            <option value="2003" <?php echo $_GET["godina"] == "2003" ? "selected" : "";?>>2003</option>
            <option value="2004" <?php echo $_GET["godina"] == "2004" ? "selected" : "";?>>2004</option>
            <option value="2005" <?php echo $_GET["godina"] == "2005" ? "selected" : "";?>>2005</option>
        </select>
