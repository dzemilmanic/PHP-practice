...
<form action="forma.php" method="GET">
    <input type="text" name="ime" placeholder="Unesite ime" required value="<?php echo $ime;?>">
    <input type="text" name="prezime" placeholder="Unesite prezime" required value="<?php echo $prezime;?>">
    <select name="godina"  >
